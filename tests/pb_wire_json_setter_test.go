...
func TestWireJsonAddRepeatedFunctions(t *testing.T) {
	...
	wire_json := "{}"
	RunTestThatExpression(t, "pb_wire_json_add_repeated_int32_field('"+wire_json+"', 1, 10, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 0, "v": 10}]}`)

	// Add second element
	wire_json = `{"1": [{"i": 0, "n": 1, "t": 0, "v": 10}]}`
	RunTestThatExpression(t, "pb_wire_json_add_repeated_int32_field('"+wire_json+"', 1, 20, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 0, "v": 10}, {"i": 1, "n": 1, "t": 0, "v": 20}]}`)

	// Test all VARINT repeated types
	RunTestThatExpression(t, "pb_wire_json_add_repeated_int64_field('{}', 1, -1, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 0, "v": 18446744073709551615}]}`)

	RunTestThatExpression(t, "pb_wire_json_add_repeated_uint32_field('{}', 1, 4294967295, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 0, "v": 4294967295}]}`)

	RunTestThatExpression(t, "pb_wire_json_add_repeated_uint64_field('{}', 1, 18446744073709551615, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 0, "v": 18446744073709551615}]}`)

	RunTestThatExpression(t, "pb_wire_json_add_repeated_sint32_field('{}', 1, -2, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 0, "v": 3}]}`) // ZigZag: -2 -> 3

	RunTestThatExpression(t, "pb_wire_json_add_repeated_sint64_field('{}', 1, -2, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 0, "v": 3}]}`) // ZigZag: -2 -> 3

	RunTestThatExpression(t, "pb_wire_json_add_repeated_enum_field('{}', 1, 100, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 0, "v": 100}]}`)

	RunTestThatExpression(t, "pb_wire_json_add_repeated_bool_field('{}', 1, TRUE, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 0, "v": 1}]}`)

	// Test I32 repeated types
	RunTestThatExpression(t, "pb_wire_json_add_repeated_fixed32_field('{}', 1, 123, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 5, "v": 123}]}`)

	RunTestThatExpression(t, "pb_wire_json_add_repeated_sfixed32_field('{}', 1, -123, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 5, "v": 4294967173}]}`)

	RunTestThatExpression(t, "pb_wire_json_add_repeated_float_field('{}', 1, 2.5, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 5, "v": 1075838976}]}`)

	// Test I64 repeated types
	RunTestThatExpression(t, "pb_wire_json_add_repeated_fixed64_field('{}', 1, 456, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 1, "v": 456}]}`)

	RunTestThatExpression(t, "pb_wire_json_add_repeated_sfixed64_field('{}', 1, -456, FALSE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 1, "v": 18446744073709551160}]}`)

	RunTestThatExpression(t, "pb_wire_json_add_repeated_double_field('{}', 1, 2.5, FALSE)").
...
func TestWireJsonAddRepeatedFunctionsPacked(t *testing.T) {
	...
	RunTestThatExpression(t, "pb_wire_json_add_repeated_int32_field('{}', 1, 10, TRUE)").
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 2, "v": "Cg=="}]}`) // 10 as varint in base64

	// Test appending to packed field
	wire_json := `{"1": [{"i": 0, "n": 1, "t": 2, "v": "Cg=="}]}`
	RunTestThatExpression(t, "pb_wire_json_add_repeated_int32_field(?, 1, 20, TRUE)", wire_json).
...
func TestWireJsonSetRepeatedFunctions(t *testing.T) {
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_int32_field(?, 1, 1, 99)", wire_json_int32).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_int64_field(?, 1, 0, -1)", wire_json_int64).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_uint32_field(?, 1, 1, 4294967295)", wire_json_uint32).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_uint64_field(?, 1, 0, 18446744073709551615)", wire_json_uint64).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_sint32_field(?, 1, 0, -5)", wire_json_sint32).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_sint64_field(?, 1, 1, -10)", wire_json_sint64).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_enum_field(?, 1, 0, 42)", wire_json_enum).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_bool_field(?, 1, 1, TRUE)", wire_json_bool).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_fixed32_field(?, 1, 0, 999)", wire_json_fixed32).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_sfixed32_field(?, 1, 1, -999)", wire_json_sfixed32).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_float_field(?, 1, 0, 1.5)", wire_json_float).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_fixed64_field(?, 1, 1, 999)", wire_json_fixed64).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_sfixed64_field(?, 1, 0, -999)", wire_json_sfixed64).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_double_field(?, 1, 1, 1.5)", wire_json_double).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_string_field(?, 2, 0, 'goodbye')", wire_json_string).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_bytes_field(?, 2, 1, _binary X'cafebabe')", wire_json_bytes).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_message_field(?, 2, 0, _binary X'200c')", wire_json_message).
...
func TestWireJsonRemoveRepeatedFunctions(t *testing.T) {
	...
	RunTestThatExpression(t, "pb_wire_json_remove_repeated_int32_field(?, 1, 1)", wire_json_int32).
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 0, "v": 10}, {"i": 2, "n": 1, "t": 0, "v": 30}]}`)
	// Remove first element (index 0)
	RunTestThatExpression(t, "pb_wire_json_remove_repeated_int32_field(?, 1, 0)", wire_json_int32).
		IsEqualToJsonString(`{"1": [{"i": 1, "n": 1, "t": 0, "v": 20}, {"i": 2, "n": 1, "t": 0, "v": 30}]}`)
	// Remove last element (index 2)
	RunTestThatExpression(t, "pb_wire_json_remove_repeated_int32_field(?, 1, 2)", wire_json_int32).
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 0, "v": 10}, {"i": 1, "n": 1, "t": 0, "v": 20}]}`)

	// Test removing all elements from a field with single element
	wire_json_single := `{"1": [{"i": 0, "n": 1, "t": 0, "v": 42}]}`
	RunTestThatExpression(t, "pb_wire_json_remove_repeated_int32_field(?, 1, 0)", wire_json_single).
		IsEqualToJsonString(`{}`) // Field should be completely removed

	// VARINT types - other types
	wire_json_int64 := `{"1": [{"i": 0, "n": 1, "t": 0, "v": 1000}, {"i": 1, "n": 1, "t": 0, "v": 2000}]}`
	RunTestThatExpression(t, "pb_wire_json_remove_repeated_int64_field(?, 1, 0)", wire_json_int64).
		IsEqualToJsonString(`{"1": [{"i": 1, "n": 1, "t": 0, "v": 2000}]}`)

	wire_json_uint32 := `{"1": [{"i": 0, "n": 1, "t": 0, "v": 100}, {"i": 1, "n": 1, "t": 0, "v": 200}]}`
	RunTestThatExpression(t, "pb_wire_json_remove_repeated_uint32_field(?, 1, 1)", wire_json_uint32).
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 0, "v": 100}]}`)

	// I32 types - fixed32
	wire_json_fixed32 := `{"1": [{"i": 0, "n": 1, "t": 5, "v": 123}, {"i": 1, "n": 1, "t": 5, "v": 456}]}`
	RunTestThatExpression(t, "pb_wire_json_remove_repeated_fixed32_field(?, 1, 0)", wire_json_fixed32).
		IsEqualToJsonString(`{"1": [{"i": 1, "n": 1, "t": 5, "v": 456}]}`)

	// I64 types - fixed64
	wire_json_fixed64 := `{"1": [{"i": 0, "n": 1, "t": 1, "v": 123}, {"i": 1, "n": 1, "t": 1, "v": 456}]}`
	RunTestThatExpression(t, "pb_wire_json_remove_repeated_fixed64_field(?, 1, 1)", wire_json_fixed64).
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 1, "v": 123}]}`)

	// LEN types - string
	wire_json_string := `{"2": [{"i": 0, "n": 2, "t": 2, "v": "aGVsbG8="}, {"i": 1, "n": 2, "t": 2, "v": "d29ybGQ="}]}` // "hello", "world"
	RunTestThatExpression(t, "pb_wire_json_remove_repeated_string_field(?, 2, 0)", wire_json_string).
		IsEqualToJsonString(`{"2": [{"i": 1, "n": 2, "t": 2, "v": "d29ybGQ="}]}`) // "world"

	// LEN types - bytes
	wire_json_bytes := `{"2": [{"i": 0, "n": 2, "t": 2, "v": "q80="}, {"i": 1, "n": 2, "t": 2, "v": "3q2+7w=="}]}` // 0xabcd, 0xdeadbeef
	RunTestThatExpression(t, "pb_wire_json_remove_repeated_bytes_field(?, 2, 1)", wire_json_bytes).
...
func TestWireJsonSetRepeatedFunctionsPacked(t *testing.T) {
	...
	packed_int32 := `{"1": [{"i": 0, "n": 1, "t": 2, "v": "ChQe"}]}`
	RunTestThatExpression(t, "pb_wire_json_set_repeated_int32_field(?, 1, 0, 99)", packed_int32).
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 2, "v": "YxQe"}]}`) // 0x63 (99), 0x14 (20), 0x1E (30)
	RunTestThatExpression(t, "pb_wire_json_set_repeated_int32_field(?, 1, 1, 88)", packed_int32).
		IsEqualToJsonString(`{"1": [{"i": 0, "n": 1, "t": 2, "v": "Clge"}]}`) // 0x0A (10), 0x58 (88), 0x1E (30)
	RunTestThatExpression(t, "pb_wire_json_set_repeated_int32_field(?, 1, 2, 77)", packed_int32).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_int64_field(?, 1, 0, 1024)", packed_int64).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_uint32_field(?, 1, 1, 300)", packed_uint32).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_uint64_field(?, 1, 0, 99)", packed_uint64).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_sint32_field(?, 1, 0, -5)", packed_sint32).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_sint64_field(?, 1, 1, -10)", packed_sint64).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_enum_field(?, 1, 0, 42)", packed_enum).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_bool_field(?, 1, 1, TRUE)", packed_bool).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_fixed32_field(?, 1, 0, 3)", packed_fixed32).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_sfixed32_field(?, 1, 1, -2)", packed_sfixed32).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_float_field(?, 1, 0, 3.0)", packed_float).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_fixed64_field(?, 1, 1, 3)", packed_fixed64).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_sfixed64_field(?, 1, 0, -2)", packed_sfixed64).
	...
	RunTestThatExpression(t, "pb_wire_json_set_repeated_double_field(?, 1, 1, 3.0)", packed_double).
