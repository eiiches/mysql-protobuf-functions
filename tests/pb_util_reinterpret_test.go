...
func TestUtilReinterpretFloatAsUint32(t *testing.T) {
	...
	RunTestThatExpression(t, "_pb_util_reinterpret_float_as_uint32(-0.0)").IsEqualToUint(0x80000000) // -0.0
...
func TestUtilReinterpretDoubleAsUint64(t *testing.T) {
	...
	RunTestThatExpression(t, "_pb_util_reinterpret_double_as_uint64(-0.0)").IsEqualToUint(0x8000000000000000) // -0.0
