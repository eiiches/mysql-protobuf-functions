...
func testMessageToNumberJson(t *testing.T, fieldDefinition string, input string, expectedNumberJson string) {
	...
	// Also test against Go protonumberjson package for consistency
	expectedProtoNumberJson, err := protonumberjson.Marshal(dynamicMessage.Interface())
	g.Expect(err).NotTo(HaveOccurred())
	RunTestThatExpression(t, "_pb_message_to_number_json(?, ?, ?)", descriptorSetJson, typeName, serializedBinary).IsEqualToJsonString(string(expectedProtoNumberJson))
}

func TestMessageToNumberJsonSingularFields(t *testing.T) {
	t.Run("int32", func(t *testing.T) {
		testMessageToNumberJson(t, "int32 int32_field = 1;", `{"int32Field": 0}`, `{"1": 0}`)
	...
	t.Run("uint32", func(t *testing.T) {
		testMessageToNumberJson(t, "uint32 uint32_field = 1;", `{"uint32Field": 0}`, `{"1": 0}`)
		testMessageToNumberJson(t, "uint32 uint32_field = 1;", `{"uint32Field": 4294967295}`, `{"1": 4294967295}`)
	})

	t.Run("int64", func(t *testing.T) {
		testMessageToNumberJson(t, "int64 int64_field = 1;", `{"int64Field": "0"}`, `{"1": 0}`)
	...
	t.Run("uint64", func(t *testing.T) {
		testMessageToNumberJson(t, "uint64 uint64_field = 1;", `{"uint64Field": "0"}`, `{"1": 0}`)
	...
	t.Run("fixed32", func(t *testing.T) {
		testMessageToNumberJson(t, "fixed32 fixed32_field = 1;", `{"fixed32Field": 0}`, `{"1": 0}`)
		testMessageToNumberJson(t, "fixed32 fixed32_field = 1;", `{"fixed32Field": 4294967295}`, `{"1": 4294967295}`)
	})

	t.Run("fixed64", func(t *testing.T) {
		testMessageToNumberJson(t, "fixed64 fixed64_field = 1;", `{"fixed64Field": "0"}`, `{"1": 0}`)
	...
	t.Run("sfixed32", func(t *testing.T) {
		testMessageToNumberJson(t, "sfixed32 sfixed32_field = 1;", `{"sfixed32Field": 0}`, `{"1": 0}`)
	...
	t.Run("sfixed64", func(t *testing.T) {
		testMessageToNumberJson(t, "sfixed64 sfixed64_field = 1;", `{"sfixed64Field": "0"}`, `{"1": 0}`)
	...
	t.Run("bool", func(t *testing.T) {
		testMessageToNumberJson(t, "bool bool_field = 1;", `{"boolField": false}`, `{"1": false}`)
		testMessageToNumberJson(t, "bool bool_field = 1;", `{"boolField": true}`, `{"1": true}`)
	})

	t.Run("string", func(t *testing.T) {
		testMessageToNumberJson(t, "string string_field = 1;", `{"stringField": ""}`, `{"1": ""}`)
		testMessageToNumberJson(t, "string string_field = 1;", `{"stringField": "test"}`, `{"1": "test"}`)
	})

	t.Run("bytes", func(t *testing.T) {
		testMessageToNumberJson(t, "bytes bytes_field = 1;", `{"bytesField": ""}`, `{"1": ""}`)
		testMessageToNumberJson(t, "bytes bytes_field = 1;", `{"bytesField": "aGVsbG8="}`, `{"1": "aGVsbG8="}`)
	})

	t.Run("float", func(t *testing.T) {
		testMessageToNumberJson(t, "float float_field = 1;", `{"floatField": 0}`, `{"1": 0}`)
		testMessageToNumberJson(t, "float float_field = 1;", `{"floatField": 3.5}`, `{"1": 3.5}`)
	})

	t.Run("double", func(t *testing.T) {
		testMessageToNumberJson(t, "double double_field = 1;", `{"doubleField": 0}`, `{"1": 0}`)
	...
	t.Run("sint32", func(t *testing.T) {
		testMessageToNumberJson(t, "sint32 sint32_field = 1;", `{"sint32Field": 0}`, `{"1": 0}`)
	...
	t.Run("sint64", func(t *testing.T) {
		testMessageToNumberJson(t, "sint64 sint64_field = 1;", `{"sint64Field": "0"}`, `{"1": 0}`)
	...
	t.Run("enum", func(t *testing.T) {
		testMessageToNumberJson(t, "EnumType enum_field = 1;", `{"enumField": "ENUM_TYPE_UNSPECIFIED"}`, `{"1": 0}`)
	...
	t.Run("message", func(t *testing.T) {
		...
		testMessageToNumberJson(t, "MessageType message_field = 1;", `{"messageField": {"value": 0}}`, `{"1": {"1": 0}}`)
...
func TestMessageToNumberJsonRepeatedFields(t *testing.T) {
	t.Run("repeated int32", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated int32 repeated_int32_field = 1;", `{"repeatedInt32Field": []}`, `{"1": []}`)
	...
	t.Run("repeated uint32", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated uint32 repeated_uint32_field = 1;", `{"repeatedUint32Field": []}`, `{"1": []}`)
	...
	t.Run("repeated int64", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated int64 repeated_int64_field = 1;", `{"repeatedInt64Field": []}`, `{"1": []}`)
	...
	t.Run("repeated uint64", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated uint64 repeated_uint64_field = 1;", `{"repeatedUint64Field": []}`, `{"1": []}`)
	...
	t.Run("repeated fixed32", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated fixed32 repeated_fixed32_field = 1;", `{"repeatedFixed32Field": []}`, `{"1": []}`)
	...
	t.Run("repeated fixed64", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated fixed64 repeated_fixed64_field = 1;", `{"repeatedFixed64Field": []}`, `{"1": []}`)
	...
	t.Run("repeated sfixed32", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated sfixed32 repeated_sfixed32_field = 1;", `{"repeatedSfixed32Field": []}`, `{"1": []}`)
	...
	t.Run("repeated sfixed64", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated sfixed64 repeated_sfixed64_field = 1;", `{"repeatedSfixed64Field": []}`, `{"1": []}`)
	...
	t.Run("repeated bool", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated bool repeated_bool_field = 1;", `{"repeatedBoolField": []}`, `{"1": []}`)
	...
	t.Run("repeated float", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated float repeated_float_field = 1;", `{"repeatedFloatField": []}`, `{"1": []}`)
	...
	t.Run("repeated double", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated double repeated_double_field = 1;", `{"repeatedDoubleField": []}`, `{"1": []}`)
	...
	t.Run("repeated sint32", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated sint32 repeated_sint32_field = 1;", `{"repeatedSint32Field": []}`, `{"1": []}`)
	...
	t.Run("repeated sint64", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated sint64 repeated_sint64_field = 1;", `{"repeatedSint64Field": []}`, `{"1": []}`)
	...
	t.Run("repeated enum", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated EnumType repeated_enum_field = 1;", `{"repeatedEnumField": []}`, `{"1": []}`)
	...
	t.Run("repeated message", func(t *testing.T) {
		testMessageToNumberJson(t, "repeated MessageType repeated_message_field = 1;", `{"repeatedMessageField": []}`, `{"1": []}`)
		testMessageToNumberJson(t, "repeated MessageType repeated_message_field = 1;", `{"repeatedMessageField": [{"value": 0}]}`, `{"1": [{"1": 0}]}`)
...
func TestMessageToNumberJsonOptionalFields(t *testing.T) {
	...
	t.Run("optional message", func(t *testing.T) {
		...
		testMessageToNumberJson(t, "optional MessageType optional_message_field = 1;", `{"optionalMessageField": {"value": 0}}`, `{"1": {"1": 0}}`)
...
func TestMessageToNumberJsonMapKey(t *testing.T) {
	t.Run("map<int32, *>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<int32, string> int32_key_map_field = 1;", `{"int32KeyMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<uint32, *>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<uint32, string> uint32_key_map_field = 1;", `{"uint32KeyMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<int64, *>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<int64, string> int64_key_map_field = 1;", `{"int64KeyMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<uint64, *>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<uint64, string> uint64_key_map_field = 1;", `{"uint64KeyMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<fixed32, *>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<fixed32, string> fixed32_key_map_field = 1;", `{"fixed32KeyMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<fixed64, *>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<fixed64, string> fixed64_key_map_field = 1;", `{"fixed64KeyMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<sfixed32, *>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<sfixed32, string> sfixed32_key_map_field = 1;", `{"sfixed32KeyMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<sfixed64, *>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<sfixed64, string> sfixed64_key_map_field = 1;", `{"sfixed64KeyMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<bool, *>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<bool, string> bool_key_map_field = 1;", `{"boolKeyMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<string, *>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, string> string_key_map_field = 1;", `{"stringKeyMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<sint32, *>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<sint32, string> sint32_key_map_field = 1;", `{"sint32KeyMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<sint64, *>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<sint64, string> sint64_key_map_field = 1;", `{"sint64KeyMapField": {}}`, `{"1": {}}`)
...
func TestMessageToNumberJsonMapValue(t *testing.T) {
	t.Run("map<*, int32>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, int32> int32_value_map_field = 1;", `{"int32ValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, uint32>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, uint32> uint32_value_map_field = 1;", `{"uint32ValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, int64>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, int64> int64_value_map_field = 1;", `{"int64ValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, uint64>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, uint64> uint64_value_map_field = 1;", `{"uint64ValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, fixed32>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, fixed32> fixed32_value_map_field = 1;", `{"fixed32ValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, fixed64>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, fixed64> fixed64_value_map_field = 1;", `{"fixed64ValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, sfixed32>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, sfixed32> sfixed32_value_map_field = 1;", `{"sfixed32ValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, sfixed64>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, sfixed64> sfixed64_value_map_field = 1;", `{"sfixed64ValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, bool>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, bool> bool_value_map_field = 1;", `{"boolValueMapField": {}}`, `{"1": {}}`)
		testMessageToNumberJson(t, "map<string, bool> bool_value_map_field = 1;", `{"boolValueMapField": {"a": false, "b": true}}`, `{"1": {"a": false, "b": true}}`)
	})

	t.Run("map<*, string>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, string> string_value_map_field = 1;", `{"stringValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, bytes>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, bytes> bytes_value_map_field = 1;", `{"bytesValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, float>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, float> float_value_map_field = 1;", `{"floatValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, double>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, double> double_value_map_field = 1;", `{"doubleValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, sint32>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, sint32> sint32_value_map_field = 1;", `{"sint32ValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, sint64>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, sint64> sint64_value_map_field = 1;", `{"sint64ValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, EnumType>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, EnumType> enum_value_map_field = 1;", `{"enumValueMapField": {}}`, `{"1": {}}`)
	...
	t.Run("map<*, MessageType>", func(t *testing.T) {
		testMessageToNumberJson(t, "map<string, MessageType> message_value_map_field = 1;", `{"messageValueMapField": {}}`, `{"1": {}}`)
		testMessageToNumberJson(t, "map<string, MessageType> message_value_map_field = 1;", `{"messageValueMapField": {"a": {"value": 0}, "b": {"value": 12345}}}`, `{"1": {"a": {"1": 0}, "b": {"1": 12345}}}`)
	})
}
...
func TestMessageToNumberJsonWellKnownTypes(t *testing.T) {
	t.Run("Timestamp", func(t *testing.T) {
		testMessageToNumberJson(t, "google.protobuf.Timestamp timestamp_field = 1;", `{"timestampField": "1970-01-01T00:00:00Z"}`, `{"1": "1970-01-01T00:00:00Z"}`)
		testMessageToNumberJson(t, "google.protobuf.Timestamp timestamp_field = 1;", `{"timestampField": "2023-10-01T12:34:56.789Z"}`, `{"1": "2023-10-01T12:34:56.789Z"}`)
		testMessageToNumberJson(t, "google.protobuf.Timestamp timestamp_field = 1;", `{"timestampField": "2023-10-01T12:34:56.789Z"}`, `{"1": "2023-10-01T12:34:56.789Z"}`)
	})

	t.Run("Duration", func(t *testing.T) {
		testMessageToNumberJson(t, "google.protobuf.Duration duration_field = 1;", `{"durationField": "0s"}`, `{"1": "0s"}`)
		testMessageToNumberJson(t, "google.protobuf.Duration duration_field = 1;", `{"durationField": "1.234s"}`, `{"1": "1.234s"}`)
	})

	t.Run("Struct", func(t *testing.T) {
		testMessageToNumberJson(t, "google.protobuf.Struct struct_field = 1;", `{"structField": {}}`, `{"1": {}}`)
		testMessageToNumberJson(t, "google.protobuf.Struct struct_field = 1;", `{"structField": {"key": "value"}}`, `{"1": {"key": "value"}}`)
		testMessageToNumberJson(t, "google.protobuf.Struct struct_field = 1;", `{"structField": {"number": 123, "boolean": true}}`, `{"1": {"number": 123, "boolean": true}}`)
	})

	t.Run("ListValue", func(t *testing.T) {
		testMessageToNumberJson(t, "google.protobuf.ListValue list_value_field = 1;", `{"listValueField": []}`, `{"1": []}`)
		testMessageToNumberJson(t, "google.protobuf.ListValue list_value_field = 1;", `{"listValueField": ["string", 123, true]}`, `{"1": ["string", 123, true]}`)
	})

	t.Run("Value", func(t *testing.T) {
		testMessageToNumberJson(t, "google.protobuf.Value value_field = 1;", `{"valueField": {}}`, `{"1": {}}`)
		testMessageToNumberJson(t, "google.protobuf.Value value_field = 1;", `{"valueField": "string"}`, `{"1": "string"}`)
		testMessageToNumberJson(t, "google.protobuf.Value value_field = 1;", `{"valueField": 123}`, `{"1": 123}`)
		testMessageToNumberJson(t, "google.protobuf.Value value_field = 1;", `{"valueField": true}`, `{"1": true}`)
	})
	...
	t.Run("DoubleValue", func(t *testing.T) {
		...
		testMessageToNumberJson(t, "google.protobuf.DoubleValue double_value_field = 1;", `{"doubleValueField": 0}`, `{"1": 0}`)
		testMessageToNumberJson(t, "google.protobuf.DoubleValue double_value_field = 1;", `{"doubleValueField": 1.7976931348623157e+308}`, `{"1": 1.7976931348623157e+308}`)
	})

	t.Run("FloatValue", func(t *testing.T) {
		testMessageToNumberJson(t, "google.protobuf.FloatValue float_value_field = 1;", `{}`, `{}`)
		testMessageToNumberJson(t, "google.protobuf.FloatValue float_value_field = 1;", `{"floatValueField": 0}`, `{"1": 0}`)
		testMessageToNumberJson(t, "google.protobuf.FloatValue float_value_field = 1;", `{"floatValueField": 3.5}`, `{"1": 3.5}`)
	})

	t.Run("Int64Value", func(t *testing.T) {
		testMessageToNumberJson(t, "google.protobuf.Int64Value int64_value_field = 1;", `{}`, `{}`)
		testMessageToNumberJson(t, "google.protobuf.Int64Value int64_value_field = 1;", `{"int64ValueField": "0"}`, `{"1": 0}`)
		testMessageToNumberJson(t, "google.protobuf.Int64Value int64_value_field = 1;", `{"int64ValueField": "9223372036854775807"}`, `{"1": 9223372036854775807}`)
		testMessageToNumberJson(t, "google.protobuf.Int64Value int64_value_field = 1;", `{"int64ValueField": "-9223372036854775808"}`, `{"1": -9223372036854775808}`)
	})

	t.Run("UInt64Value", func(t *testing.T) {
		testMessageToNumberJson(t, "google.protobuf.UInt64Value uint64_value_field = 1;", `{}`, `{}`)
		testMessageToNumberJson(t, "google.protobuf.UInt64Value uint64_value_field = 1;", `{"uint64ValueField": "0"}`, `{"1": 0}`)
		testMessageToNumberJson(t, "google.protobuf.UInt64Value uint64_value_field = 1;", `{"uint64ValueField": "18446744073709551615"}`, `{"1": 18446744073709551615}`)
	})

	t.Run("Int32Value", func(t *testing.T) {
		testMessageToNumberJson(t, "google.protobuf.Int32Value int32_value_field = 1;", `{}`, `{}`)
		testMessageToNumberJson(t, "google.protobuf.Int32Value int32_value_field = 1;", `{"int32ValueField": 0}`, `{"1": 0}`)
		testMessageToNumberJson(t, "google.protobuf.Int32Value int32_value_field = 1;", `{"int32ValueField": 2147483647}`, `{"1": 2147483647}`)
		testMessageToNumberJson(t, "google.protobuf.Int32Value int32_value_field = 1;", `{"int32ValueField": -2147483648}`, `{"1": -2147483648}`)
	})

	t.Run("UInt32Value", func(t *testing.T) {
		testMessageToNumberJson(t, "google.protobuf.UInt32Value uint32_value_field = 1;", `{}`, `{}`)
		testMessageToNumberJson(t, "google.protobuf.UInt32Value uint32_value_field = 1;", `{"uint32ValueField": 0}`, `{"1": 0}`)
		testMessageToNumberJson(t, "google.protobuf.UInt32Value uint32_value_field = 1;", `{"uint32ValueField": 4294967295}`, `{"1": 4294967295}`)
	})

	t.Run("BoolValue", func(t *testing.T) {
		testMessageToNumberJson(t, "google.protobuf.BoolValue bool_value_field = 1;", `{}`, `{}`)
		testMessageToNumberJson(t, "google.protobuf.BoolValue bool_value_field = 1;", `{"boolValueField": false}`, `{"1": false}`)
		testMessageToNumberJson(t, "google.protobuf.BoolValue bool_value_field = 1;", `{"boolValueField": true}`, `{"1": true}`)
	})
	...
	t.Run("StringValue", func(t *testing.T) {
		...
		testMessageToNumberJson(t, "google.protobuf.StringValue string_value_field = 1;", `{"stringValueField": "test"}`, `{"1": "test"}`)
	})
	...
	t.Run("BytesValue", func(t *testing.T) {
		...
		testMessageToNumberJson(t, "google.protobuf.BytesValue bytes_value_field = 1;", `{"bytesValueField": "aGVsbG8="}`, `{"1": "aGVsbG8="}`)
	})
	...
	t.Run("FieldMask", func(t *testing.T) {
		...
		testMessageToNumberJson(t, "google.protobuf.FieldMask field_mask_field = 1;", `{"fieldMaskField": "path1,path2"}`, `{"1": "path1,path2"}`)
	})
}
