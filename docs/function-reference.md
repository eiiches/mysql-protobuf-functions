...
- **Schema Processing**: `pb_descriptor_set_build()`
...
**Parameters:**
- `descriptor_set_json` (JSON): A JSON object containing the descriptor set information, typically generated by `pb_descriptor_set_build()`
...
SET @schema_json = pb_descriptor_set_build(@descriptor_set_blob);
...
#### `pb_descriptor_set_build(file_descriptor_set LONGBLOB) -> JSON`
...
- **`pb_descriptor_set_build`**: Schema processing operations
