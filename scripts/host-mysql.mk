...
start-mysql: download-mysql
	...
	nohup $(MYSQLD_BIN) --datadir=$(MYSQL_DATADIR) --bind-address=$(MYSQL_BIND_ADDRESS) --port=$(MYSQL_PORT) --performance-schema-events-statements-history-long-size=1000000 --stored_program_cache=512 > mysql.out & echo $$! > mysql.pid
	set -euxo pipefail; \
