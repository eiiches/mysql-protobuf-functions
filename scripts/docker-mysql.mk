...
start-mysql: download-mysql
	docker run -d --rm --name test-mysql --tmpfs /var/lib/mysql -p $(MYSQL_BIND_ADDRESS):$(MYSQL_PORT):3306 -e MYSQL_ALLOW_EMPTY_PASSWORD=true -e MYSQL_DATABASE=test mysql:8.0.17 --performance-schema-events-statements-history-long-size=1000000 --stored_program_cache=1024
	set -euxo pipefail; \
